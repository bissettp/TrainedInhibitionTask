...
# -*- coding: utf-8 -*-
"""
This experiment was created using PsychoPy2 Experiment Builder (v1.82.01), Tue Mar 24 16:00:23 2015
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'/Users/patrickbissett/OneDrive/Poldrack/TrainedInhibition/PsychoPy/ShapeLearningTaskCounterbalanceRemovePrac4.psyexp',
...
image_3 = visual.ImageStim(win=win, name='image_3',units='pix', 
    image=currentGoStim, mask=None,
    ori=0, pos=[xPosGoStim, 0], size=[151, 151],
    color=[1,1,1], colorSpace='rgb', opacity=1,
    flipHoriz=False, flipVert=False,
...
Blocks = data.TrialHandler(nReps=4, method='sequential', 
    extraInfo=expInfo, originPath=u'/Users/patrickbissett/OneDrive/Poldrack/TrainedInhibition/PsychoPy/ShapeLearningTaskCounterbalanceRemovePrac4.psyexp',
    trialList=[None],
...
for thisStopBlock in StopBlocks:
    ...
    # set up handler to look after randomisation of conditions etc
    StopTrials = data.TrialHandler(nReps=34, method='fullRandom', 
        extraInfo=expInfo, originPath=u'/Users/patrickbissett/OneDrive/Poldrack/TrainedInhibition/PsychoPy/ShapeLearningTaskCounterbalanceRemovePrac4.psyexp',
        trialList=data.importConditions(u'trialtypeStop.xlsx'),
    ...
    for thisStopTrial in StopTrials:
        ...
        while continueRoutine:
            ...
            # start/stop sound_1
            if t >= SSD + 500 and sound_1.status == NOT_STARTED:
                # keep track of start time/frame for later
                sound_1.tStart = t  # underestimates by a little under one frame
                sound_1.frameNStart = frameN  # exact frame index
                sound_1.play()  # start the sound (it finishes automatically)
            if sound_1.status == STARTED and t >= (SSD + 500 + (.2-win.monitorFramePeriod*0.75)): #most of one frame period left
        ...
        if stopResp.keys is None and currentStopTrial['stopOrGo'] == 'go':
            omissionCount = 0
    ...
    # completed 34 repeats of 'StopTrials'
    ...
    SSDFeedback = str(numpy.mean(SSDLeft, SSDRight))
