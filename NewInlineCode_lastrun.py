...
# -*- coding: utf-8 -*-
"""
This experiment was created using PsychoPy2 Experiment Builder (v1.81.03), Wed Mar  4 13:57:49 2015
...
expName = u'NewInlineCode'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'/Users/patrickbissett/OneDrive/Poldrack/TrainedInhibition/PsychoPy/NewInlineCode.psyexp',
...
rewards = [0.5, 1, 2, 4] * 2
conditions = list('XXXXYYYY')
trialDetailsList = []

shuffle(colors)
shuffle(shapes)

for i, color in enumerate(colors): # cycle through each colour and keep track of an index number
...
currentDetails = trialDetailsList.pop()
