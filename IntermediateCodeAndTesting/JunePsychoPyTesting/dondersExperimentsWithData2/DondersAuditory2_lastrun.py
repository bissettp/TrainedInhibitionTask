...
# -*- coding: utf-8 -*-
"""
This experiment was created using PsychoPy2 Experiment Builder (v1.82.01), Tue Jun  2 16:06:59 2015
...
expName = 'DondersAuditory2'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'/Users/poldracklab/Desktop/dondersExperimentsWithData/DondersAuditory2.psyexp',
...
trials = data.TrialHandler(nReps=100, method='random', 
    extraInfo=expInfo, originPath=u'/Users/poldracklab/Desktop/dondersExperimentsWithData/DondersAuditory2.psyexp',
    trialList=[None],
...
for thisTrial in trials:
    ...
    while continueRoutine:
        ...
        # *text_2* updates
        if t >= jitter and text_2.status == NOT_STARTED:
            # keep track of start time/frame for later
            text_2.tStart = t  # underestimates by a little under one frame
            text_2.frameNStart = frameN  # exact frame index
            text_2.setAutoDraw(True)
        if text_2.status == STARTED and t >= (jitter + (.2-win.monitorFramePeriod*0.75)): #most of one frame period left
    ...
    if key_resp_2.keys in ['', [], None]:  # No response was made
       ...
       if str("'space'").lower() == 'none': key_resp_2.corr = 1  # correct non-response
