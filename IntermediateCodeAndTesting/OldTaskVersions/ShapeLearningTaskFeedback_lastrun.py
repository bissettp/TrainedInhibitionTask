...
# -*- coding: utf-8 -*-
"""
This experiment was created using PsychoPy2 Experiment Builder (v1.82.01), Wed Mar 18 15:15:19 2015
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'/Users/patrickbissett/OneDrive/Poldrack/TrainedInhibition/PsychoPy/ShapeLearningTaskFeedback.psyexp',
...
practiceTrials = data.TrialHandler(nReps=2.0, method='fullRandom', 
    extraInfo=expInfo, originPath=u'/Users/patrickbissett/OneDrive/Poldrack/TrainedInhibition/PsychoPy/ShapeLearningTaskFeedback.psyexp',
...
for thisPracticeTrial in practiceTrials:
    ...
    for thisReDoLoop in ReDoLoop:
        ...
        feedback_2.setText("You won " + str(message))
        # keep track of which components have finished
        feedbackComponents = []
...
# set up handler to look after randomisation of conditions etc
trials = data.TrialHandler(nReps=12.5, method='fullRandom', 
    extraInfo=expInfo, originPath=u'/Users/patrickbissett/OneDrive/Poldrack/TrainedInhibition/PsychoPy/ShapeLearningTaskFeedback.psyexp',
...
# completed 12.5 repeats of 'trials'
