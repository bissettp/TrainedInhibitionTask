...
# -*- coding: utf-8 -*-
"""
This experiment was created using PsychoPy2 Experiment Builder (v1.82.01), Thu Mar 19 10:20:39 2015
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'/Users/patrickbissett/OneDrive/Poldrack/TrainedInhibition/PsychoPy/ShapeLearningTaskFeedback11.psyexp',
...
practiceTrials = data.TrialHandler(nReps=2.0, method='fullRandom', 
    extraInfo=expInfo, originPath=u'/Users/patrickbissett/OneDrive/Poldrack/TrainedInhibition/PsychoPy/ShapeLearningTaskFeedback11.psyexp',
        ...
        if resp.corr:#stored on last run routine
            if DisplayReward == 1:
                ...
                if ConditionChoice == 1:
                    ...
                    CurrentReward = Cond4itionTwo['reward']
                    message = "You won $ " + str(CurrentReward + (random.randrange(-25, 26)*.01))
                elif ConditionChoice == 3:
