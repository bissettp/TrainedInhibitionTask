...
# -*- coding: utf-8 -*-
"""
This experiment was created using PsychoPy2 Experiment Builder (v1.82.01), Fri May 29 15:22:42 2015
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'/Users/patrickbissett/OneDrive/Poldrack/TrainedInhibition/PsychoPy/LearningStopAuctionTroubleshootingITI.psyexp',
...
pracTrials = data.TrialHandler(nReps=1, method='fullRandom', 
    extraInfo=expInfo, originPath=u'/Users/patrickbissett/OneDrive/Poldrack/TrainedInhibition/PsychoPy/LearningStopAuctionTroubleshootingITI.psyexp',
...
for thisPracTrial in pracTrials:
    ...
    for thisReDoLoopPrac in ReDoLoopPrac:
        ...
        frameN = -1
        # update component parameters for each repeat
        pracTrials.addData("StartTrialTimeStamp", core.getTime())
        # keep track of which components have finished
        ...
        if resp.corr:#stored on last run routine
            if displayReward == 1:
                    message = "You won $0.00"# On 20% of all trials I want to give a 0 reward
            else: 
        ...
        feedbackComponents.append(key_resp_8)
        ...
        while continueRoutine and routineTimer.getTime() > 0:
            ...
            if t >= 0.0 and key_resp_8.status == NOT_STARTED:
                ...
                event.clearEvents(eventType='keyboard')
            if key_resp_8.status == STARTED and t >= (0.0 + (1.0-win.monitorFramePeriod*0.75)): #most of one frame period left
        ...
        # store data for ReDoLoopPrac (TrialHandler)
        ReDoLoopPrac.addData('key_resp_8.keys',key_resp_8.keys)
        if key_resp_8.keys != None:  # we had a response
            ReDoLoopPrac.addData('key_resp_8.rt', key_resp_8.rt)
        ...
        frameN = -1
        # update component parameters for each repeat
        pracTrials.addData("EndTrialTimeStamp", core.getTime())
        # keep track of which components have finished
        endTrialComponents = []
...
for thisBlock in Blocks:
    ...
    for thisTrial in trials:
        ...
        # update component parameters for each repeat
        #***************************
        trials.addData("NewStimTimeStamp", core.getTime())
        ...
        trials.addData("EndNewStimTimeStamp", core.getTime())
        ...
        for thisReDoLoopMain in ReDoLoopMain:
            ...
            frameN = -1
            # update component parameters for each repeat
            trials.addData("StartTrialTimeStamp", core.getTime())
            # keep track of which components have finished
            ...
            if key_resp_8.keys in ['', [], None]:  # No response was made
               key_resp_8.keys=None
            # store data for ReDoLoopMain (TrialHandler)
            ReDoLoopMain.addData('key_resp_8.keys',key_resp_8.keys)
            if key_resp_8.keys != None:  # we had a response
                ReDoLoopMain.addData('key_resp_8.rt', key_resp_8.rt)
            ...
            frameN = -1
            # update component parameters for each repeat
            trials.addData("EndTrialTimeStamp", core.getTime())
            # keep track of which components have finished
