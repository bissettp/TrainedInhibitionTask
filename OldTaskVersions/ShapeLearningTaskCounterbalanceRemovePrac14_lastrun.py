...
# -*- coding: utf-8 -*-
"""
This experiment was created using PsychoPy2 Experiment Builder (v1.82.01), Tue Mar 31 16:11:35 2015
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/patrickbissett/OneDrive/Poldrack/TrainedInhibition/PsychoPy/ShapeLearningTaskCounterbalanceRemovePrac14.psyexp',
...
Blocks = data.TrialHandler(nReps=0, method='sequential', 
    extraInfo=expInfo, originPath='/Users/patrickbissett/OneDrive/Poldrack/TrainedInhibition/PsychoPy/ShapeLearningTaskCounterbalanceRemovePrac14.psyexp',
    trialList=[None],
...
for thisStopBlock in StopBlocks:
    ...
    stopMessage = " RT = " + round(str(goRTFeedback), 2) + "\n Omission % = " + round(str(omissionRate), 2) + "\n Commission % = " + round(str(commissionRate), 2) + "\n\n\n\n " + round(str(probabilityOfStop), 2) + "\n " + round(str(SSDFeedback), 2)
