...
# -*- coding: utf-8 -*-
"""
This experiment was created using PsychoPy2 Experiment Builder (v1.82.01), Wed Apr  1 14:24:01 2015
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'/Users/patrickbissett/OneDrive/Poldrack/TrainedInhibition/PsychoPy/LearningStopAuction2.psyexp',
...
pracTrials = data.TrialHandler(nReps=1, method='fullRandom', 
    extraInfo=expInfo, originPath=u'/Users/patrickbissett/OneDrive/Poldrack/TrainedInhibition/PsychoPy/LearningStopAuction2.psyexp',
    ...
    for thisReDoLoopPrac in ReDoLoopPrac:
        ...
        if resp.corr:#stored on last run routine
            if displayReward == 1:
                    ...
                    message = "You won $" + str(computedReward)
