...
# -*- coding: utf-8 -*-
"""
This experiment was created using PsychoPy2 Experiment Builder (v1.82.01), Tue Mar 31 11:50:50 2015
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'/Users/patrickbissett/OneDrive/Poldrack/TrainedInhibition/PsychoPy/ShapeLearningTaskCounterbalanceRemovePrac10.psyexp',
...
Blocks = data.TrialHandler(nReps=0, method='sequential', 
    extraInfo=expInfo, originPath=u'/Users/patrickbissett/OneDrive/Poldrack/TrainedInhibition/PsychoPy/ShapeLearningTaskCounterbalanceRemovePrac10.psyexp',
    trialList=[None],
...
for thisStopBlock in StopBlocks:
    ...
    # set up handler to look after randomisation of conditions etc
    StopTrials = data.TrialHandler(nReps=17, method='fullRandom', 
        extraInfo=expInfo, originPath=u'/Users/patrickbissett/OneDrive/Poldrack/TrainedInhibition/PsychoPy/ShapeLearningTaskCounterbalanceRemovePrac10.psyexp',
    ...
    for thisStopTrial in StopTrials:
        ...
        while continueRoutine:
            ...
            # update/draw components on each frame
            # start/stop sound_1
            if t >= SSD and sound_1.status == NOT_STARTED:
                # keep track of start time/frame for later
                sound_1.tStart = t  # underestimates by a little under one frame
                sound_1.frameNStart = frameN  # exact frame index
                sound_1.play()  # start the sound (it finishes automatically)
            if sound_1.status == STARTED and t >= (SSD + (.2-win.monitorFramePeriod*0.75)): #most of one frame period left
    ...
    # completed 17 repeats of 'StopTrials'
    ...
    stopMessage = "RT = " + str(goRTFeedback) + "Omission % = " + str(omissionRate) + "Commission % = " + str(commissionRate) + "    " + str(probabilityOfStop) + "    " + str(SSDFeedback)
