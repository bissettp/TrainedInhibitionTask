...
# -*- coding: utf-8 -*-
"""
This experiment was created using PsychoPy2 Experiment Builder (v1.81.02), Mon Dec 15 11:47:35 2014
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'/Users/patrickbissett/OneDrive/Poldrack/PsychoPy/stroopTest.psyexp',
...
trials = data.TrialHandler(nReps=5, method='random', 
    extraInfo=expInfo, originPath=u'/Users/patrickbissett/OneDrive/Poldrack/PsychoPy/stroopTest.psyexp',
    trialList=data.importConditions('StroopInput.xlsx'),
...
for thisTrial in trials:
    ...
    while continueRoutine:
        ...
        if target.status == STARTED and t >= (0.5 + (5.0-win.monitorFramePeriod*0.75)): #most of one frame period left
